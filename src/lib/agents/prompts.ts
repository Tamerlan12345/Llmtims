...
export const buildEphemeralSiteDirective = (): string =>
  [
    ...
    "Не экранируй HTML: никаких JSON-оберток, literal \\n, обратных слэшей на концах строк или хвостов после закрывающего </html>.",
    "Не используй via.placeholder.com, placehold.co, dummyimage.com, lorem ipsum или устаревший год в footer; если нет реальных изображений, делай CSS-блоки/градиенты.",
